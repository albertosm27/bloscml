...
for i, chunk in enumerate(chunk_generator()):
    tblz[i], rblz[i] = test_codec(chunk, 'blosclz', blosc.SHUFFLE, 9)
...
print("Pearson blz-zstd: ", pearsonr(rblz, rzstd))
print("Pearson blz-lz4: ", pearsonr(rblz, rlz4))
print("Pearson blz-lz4hc: ", pearsonr(rblz, rlz4hc))
print("Pearson blz-snappy: ", pearsonr(rblz, rsnappy))
print("Pearson blz-zlib: ", pearsonr(rblz, rzlib))
print("-------COMPRESSION TIMES---------")
print("Pearson blz-zstd: ", pearsonr(tblz,tzstd))
print("Pearson blz-lz4: ", pearsonr(tblz,tlz4))
print("Pearson blz-lz4hc: ", pearsonr(tblz,tlz4hc))
print("Pearson blz-snappy: ", pearsonr(tblz,tsnappy))
print("Pearson blz-zlib: ", pearsonr(tblz,tzlib))
